...
public static partial class BattleFormationServiceLoggerExtensions
{
    ...
    public static partial void Log_BattleFormationCreated(
        this ILogger logger,
    ...
    public static partial void Log_BattleFormationUpdated(
        this ILogger logger,
        int battleFormationId,
        int factionId
    );
    ...
    [LoggerMessage(
        Level = LogLevel.Information,
        Message = "Battle formation {BattleFormationId} deleted"
    )]
    public static partial void Log_BattleFormationDeleted(
        this ILogger logger,
        int battleFormationId
    );
    ...
    [LoggerMessage(
        ...
        Message = "Update for battle formation {BattleFormationId} with version {Version} failed because of version mismatch"
    )]
